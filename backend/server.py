...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://83993f50-e8e3-4f88-9193-8787d73814b8.preview.emergentagent.com",
                f"https://83993f50-e8e3-4f88-9193-8787d73814b8.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://83993f50-e8e3-4f88-9193-8787d73814b8.preview.emergentagent.com"
    ...
    return "https://83993f50-e8e3-4f88-9193-8787d73814b8.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://83993f50-e8e3-4f88-9193-8787d73814b8.preview.emergentagent.com":
