...
FRONTEND_ORIGINS = [
    ...
    "https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com",
                f"https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com"
    ...
    return "https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://9c70dd25-883a-44bc-ae98-3d538f3038b0.preview.emergentagent.com":
