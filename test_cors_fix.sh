...
if curl -s --max-time 3 https://df6e1c16-b65d-4e66-9634-dac10d3cbe6a.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://df6e1c16-b65d-4e66-9634-dac10d3cbe6a.preview.emergentagent.com"; do
