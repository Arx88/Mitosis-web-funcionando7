...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
        "https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
        "https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
