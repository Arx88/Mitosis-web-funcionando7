...
echo "📍 Frontend: https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
