...
FRONTEND_ORIGINS = [
    ...
    "https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com",
                f"https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com"
    ...
    return "https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://fbccc99e-1d40-4797-ac97-f134f2410c0b.preview.emergentagent.com":
