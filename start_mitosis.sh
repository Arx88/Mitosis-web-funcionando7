...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
        "https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
        "https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
