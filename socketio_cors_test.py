...
4. Origin Validation: Test with the specific frontend origin (https://a5d44523-6b54-4782-99d6-beb01a60ce68.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://a5d44523-6b54-4782-99d6-beb01a60ce68.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://a5d44523-6b54-4782-99d6-beb01a60ce68.preview.emergentagent.com",  # Alternative origin
