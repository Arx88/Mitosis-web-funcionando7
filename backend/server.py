...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
    ...
    return "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com":
