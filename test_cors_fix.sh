...
if curl -s --max-time 3 https://1a375733-8311-4aee-a369-85ffad84ce7c.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://1a375733-8311-4aee-a369-85ffad84ce7c.preview.emergentagent.com"; do
