...
VITE_BACKEND_URL=https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com"
    echo "=============================================================="
