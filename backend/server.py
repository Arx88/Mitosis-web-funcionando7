...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com",
                f"https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com"
    ...
    return "https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com":
