...
VITE_BACKEND_URL=https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com"
    echo "=============================================================="
