...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
        "https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
        "https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
