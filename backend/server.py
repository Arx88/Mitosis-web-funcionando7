...
FRONTEND_ORIGINS = [
    ...
    "https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com",
                f"https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com"
    ...
    return "https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://0bb37565-91f9-477d-80c2-4f42b14c81c5.preview.emergentagent.com":
