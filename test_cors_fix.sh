...
if curl -s --max-time 3 https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com"; do
