...
4. Origin Validation: Test with the specific frontend origin (https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com",  # Alternative origin
