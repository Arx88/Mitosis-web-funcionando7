...
VITE_BACKEND_URL=https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://e2700388-9fb2-4a79-9ec7-8101cd61d9fe.preview.emergentagent.com"
    echo "=============================================================="
