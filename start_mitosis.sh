...
VITE_BACKEND_URL=https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://e369b6ce-393b-42f9-b6cc-dce92a79667b.preview.emergentagent.com"
    echo "=============================================================="
