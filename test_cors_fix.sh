...
if curl -s --max-time 3 https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com"; do
