...
4. Origin Validation: Test with the specific frontend origin (https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com",  # Alternative origin
