...
4. Origin Validation: Test with the specific frontend origin (https://e16aaf8b-9515-4874-baf4-4996642c59cb.preview.emergentagent.com) to ensure it's allowed
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://e16aaf8b-9515-4874-baf4-4996642c59cb.preview.emergentagent.com",  # Alternative origin
