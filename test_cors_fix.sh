...
if curl -s --max-time 3 https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com"; do
