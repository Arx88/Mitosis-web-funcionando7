...
if curl -s --max-time 3 https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com"; do
