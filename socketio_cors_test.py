...
4. Origin Validation: Test with the specific frontend origin (https://0cc21d5b-587f-4659-aeaf-f6228da26a88.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://0cc21d5b-587f-4659-aeaf-f6228da26a88.preview.emergentagent.com
...
BACKEND_URL = "https://0cc21d5b-587f-4659-aeaf-f6228da26a88.preview.emergentagent.com"
FRONTEND_ORIGIN = "https://0cc21d5b-587f-4659-aeaf-f6228da26a88.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://0cc21d5b-587f-4659-aeaf-f6228da26a88.preview.emergentagent.com",  # Alternative origin
