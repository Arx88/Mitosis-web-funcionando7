...
if curl -s --max-time 3 https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com"; do
