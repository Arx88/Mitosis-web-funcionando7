...
if curl -s --max-time 3 https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com"; do
