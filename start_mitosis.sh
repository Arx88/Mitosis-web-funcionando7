...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com"
        "https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com"
        "https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://c9b3f5a2-50b2-4e2b-afee-d492801aa2e5.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
