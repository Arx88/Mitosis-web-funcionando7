...
FRONTEND_ORIGINS = [
    ...
    "https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com",
                f"https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com"
    ...
    return "https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://b78c8f87-fdab-4629-a075-f8e61eb8d6f3.preview.emergentagent.com":
