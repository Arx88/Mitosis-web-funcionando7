...
VITE_BACKEND_URL=https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com"
    echo "=============================================================="
