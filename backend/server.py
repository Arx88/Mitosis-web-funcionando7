...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com"
    ...
    return "https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com":
