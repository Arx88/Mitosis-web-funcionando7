...
4. Origin Validation: Test with the specific frontend origin (https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com",  # Alternative origin
