...
echo "📍 Frontend: https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
