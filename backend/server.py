...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://3d10b636-0cc4-4cae-86b2-4d045d292b07.preview.emergentagent.com"
    ...
    return "https://3d10b636-0cc4-4cae-86b2-4d045d292b07.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://3d10b636-0cc4-4cae-86b2-4d045d292b07.preview.emergentagent.com":
