...
BACKEND_URL = "https://63c32999-9c01-40eb-86d9-4a9e28abc65e.preview.emergentagent.com"
...
class MitosisPlanGenerationFlowTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://63c32999-9c01-40eb-86d9-4a9e28abc65e.preview.emergentagent.com'
        })
        self.test_results = []
        self.task_id = None
    ...
    def test_cors_and_headers(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                cors_configured = (
                    cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://63c32999-9c01-40eb-86d9-4a9e28abc65e.preview.emergentagent.com'] or
