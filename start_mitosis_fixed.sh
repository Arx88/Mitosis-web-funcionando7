...
echo "📍 Frontend: https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
