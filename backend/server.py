...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com",
                f"https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
    ...
    return "https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com":
