...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com ]]; then
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
