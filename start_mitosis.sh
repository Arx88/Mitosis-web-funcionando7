...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com ]]; then
...
BASE_CORS_URLS=(
    ...
    "\"https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
