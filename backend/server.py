...
FRONTEND_ORIGINS = [
    ...
    "https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com",
                f"https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com"
    ...
    return "https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://79891659-b696-4632-8c04-86f75511857b.preview.emergentagent.com":
