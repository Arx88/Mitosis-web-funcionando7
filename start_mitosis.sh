...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com ]]; then
...
BASE_CORS_URLS=(
    ...
    "\"https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
