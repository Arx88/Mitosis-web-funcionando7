...
BACKEND URL: https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com
...
BACKEND_URL = "https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com"
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com']
