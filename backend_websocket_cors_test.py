...
BACKEND URL: https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com']
