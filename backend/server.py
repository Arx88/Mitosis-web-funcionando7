...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com",
                f"https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
    ...
    return "https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com":
