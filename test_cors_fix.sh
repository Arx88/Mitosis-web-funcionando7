...
if curl -s --max-time 3 https://38146bbb-fcab-42f6-9cbd-f49422f98546.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://38146bbb-fcab-42f6-9cbd-f49422f98546.preview.emergentagent.com"; do
