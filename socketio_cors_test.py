...
4. Origin Validation: Test with the specific frontend origin (https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com",  # Alternative origin
