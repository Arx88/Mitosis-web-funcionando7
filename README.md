...
- **URL Externa**: `https://656c3d3e-b8b8-4e03-bdd7-0cd6a25edc1e.preview.emergentagent.com`
...
**Frontend (.env)**
```bash
VITE_BACKEND_URL=https://656c3d3e-b8b8-4e03-bdd7-0cd6a25edc1e.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://656c3d3e-b8b8-4e03-bdd7-0cd6a25edc1e.preview.emergentagent.com
```
