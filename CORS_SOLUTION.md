...
**Error Original:**
```
Access to XMLHttpRequest at 'https://3a6a914f-38f4-4994-976b-6a526ad6d7a0.preview.emergentagent.com/api/socket.io/' 
from origin 'https://cell-split-app-1.preview.emergentagent.com' has been blocked by CORS policy: 
...
```bash
EMERGENT_PREVIEW_URL=https://tu-app.preview.emergentagent.com
PREVIEW_URL=https://tu-app.preview.emergentagent.com
```
...
curl -s --max-time 2 https://cell-split-app-1.preview.emergentagent.com
```
...
FRONTEND_ORIGINS = [
    ...
    "https://tu-url-real.preview.emergentagent.com",
...
curl -H "Origin: https://tu-url.preview.emergentagent.com" \
