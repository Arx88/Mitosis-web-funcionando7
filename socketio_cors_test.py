...
4. Origin Validation: Test with the specific frontend origin (https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com",  # Alternative origin
