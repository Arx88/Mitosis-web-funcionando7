...
4. Origin Validation: Test with the specific frontend origin (https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com
...
BACKEND_URL = "https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com"
FRONTEND_ORIGIN = "https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://bc41adec-714d-468d-8870-badec58bf366.preview.emergentagent.com",  # Alternative origin
