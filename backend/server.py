...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://e727d8c0-6cdb-4a78-b216-fb15e8e27a4e.preview.emergentagent.com",
                f"https://e727d8c0-6cdb-4a78-b216-fb15e8e27a4e.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://e727d8c0-6cdb-4a78-b216-fb15e8e27a4e.preview.emergentagent.com"
    ...
    return "https://e727d8c0-6cdb-4a78-b216-fb15e8e27a4e.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://e727d8c0-6cdb-4a78-b216-fb15e8e27a4e.preview.emergentagent.com":
