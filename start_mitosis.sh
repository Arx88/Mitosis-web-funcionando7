...
VITE_BACKEND_URL=https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://a2591ea8-af30-4651-939c-c5501b752459.preview.emergentagent.com"
    echo "=============================================================="
