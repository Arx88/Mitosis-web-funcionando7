...
FRONTEND_ORIGINS = [
    ...
    "https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com",
                f"https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com"
    ...
    return "https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://691b5e52-79cd-4f64-a066-0c6038a363a5.preview.emergentagent.com":
