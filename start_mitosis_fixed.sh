...
echo "📍 Frontend: https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://31ac0422-78aa-4076-a1b1-c3e7b8886947.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
