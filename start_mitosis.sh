...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
        "https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
        "https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
