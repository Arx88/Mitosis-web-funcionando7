...
VITE_BACKEND_URL=https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://3bafd010-69cf-4d1c-a1c1-55447decce39.preview.emergentagent.com"
    echo "=============================================================="
