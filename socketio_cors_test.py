...
4. Origin Validation: Test with the specific frontend origin (https://7c8244f3-e97e-49c3-bcd4-bb7b083f759d.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://7c8244f3-e97e-49c3-bcd4-bb7b083f759d.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://7c8244f3-e97e-49c3-bcd4-bb7b083f759d.preview.emergentagent.com",  # Alternative origin
