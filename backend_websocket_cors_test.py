...
BACKEND URL: https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com
...
BACKEND_URL = "https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com"
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://022fe56d-38bc-4752-a5da-625969514d2c.preview.emergentagent.com']
