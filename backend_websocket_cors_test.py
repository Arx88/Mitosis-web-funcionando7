...
BACKEND_URL = "https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com"
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://52e59a01-1790-4e28-9f7a-142898d7bb56.preview.emergentagent.com']
