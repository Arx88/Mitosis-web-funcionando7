...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com",
                f"https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
    ...
    return "https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com":
