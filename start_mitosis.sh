...
VITE_BACKEND_URL=https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://2d6bd67a-c88f-4adf-aad2-a25028aa0f12.preview.emergentagent.com"
    echo "=============================================================="
