...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
        "https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
