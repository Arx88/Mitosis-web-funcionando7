...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://bb1f5fad-acf9-45e6-8f0f-3f29b9d2d67f.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://bb1f5fad-acf9-45e6-8f0f-3f29b9d2d67f.preview.emergentagent.com"
        "https://bb1f5fad-acf9-45e6-8f0f-3f29b9d2d67f.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://bb1f5fad-acf9-45e6-8f0f-3f29b9d2d67f.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://bb1f5fad-acf9-45e6-8f0f-3f29b9d2d67f.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
