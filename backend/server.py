...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"
    ...
    return "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com":
