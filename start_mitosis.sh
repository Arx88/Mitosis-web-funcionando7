...
check_external_access() {
    ...
    curl -s -f "https://e9d10c57-6ed9-40c1-8ff7-904db66dbe60.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://e9d10c57-6ed9-40c1-8ff7-904db66dbe60.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://e9d10c57-6ed9-40c1-8ff7-904db66dbe60.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://e9d10c57-6ed9-40c1-8ff7-904db66dbe60.preview.emergentagent.com"
    echo "=============================================================="
