...
BACKEND URL: https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com']
