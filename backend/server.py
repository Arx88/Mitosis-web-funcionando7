...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com",
                f"https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
    ...
    return "https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com":
