...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://2366c152-ac69-4590-8f90-0d1fd796a2a2.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://2366c152-ac69-4590-8f90-0d1fd796a2a2.preview.emergentagent.com"
        "https://2366c152-ac69-4590-8f90-0d1fd796a2a2.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://2366c152-ac69-4590-8f90-0d1fd796a2a2.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://2366c152-ac69-4590-8f90-0d1fd796a2a2.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
...
if $backend_ok; then
    ...
    ollama_check_test=$(curl -s -X POST -H "Content-Type: application/json" \
        -d '{"endpoint":"https://277e85fec6fd.ngrok-free.app"}' \
...
echo "   4. Ollama configurado automáticamente (https://277e85fec6fd.ngrok-free.app)"
