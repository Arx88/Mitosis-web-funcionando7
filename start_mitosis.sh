...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://3d9cd2d2-4ae7-4666-82e4-56c0e272b957.preview.emergentagent.com ]]; then
...
BASE_CORS_URLS=(
    ...
    "\"https://3d9cd2d2-4ae7-4666-82e4-56c0e272b957.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
