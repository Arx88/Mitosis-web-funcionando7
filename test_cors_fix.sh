...
if curl -s --max-time 3 https://971ab67f-f8ad-40d3-b270-7b1fbfe629ed.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://971ab67f-f8ad-40d3-b270-7b1fbfe629ed.preview.emergentagent.com"; do
