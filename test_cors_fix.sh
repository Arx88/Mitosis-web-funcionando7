...
if curl -s --max-time 3 https://cell-split-exec.preview.emergentagent.com >/dev/null 2>&1; then
    echo "   ✅ cell-split-exec.preview.emergentagent.com - ACCESIBLE"
else
    echo "   ❌ cell-split-exec.preview.emergentagent.com - NO ACCESIBLE"
fi

if curl -s --max-time 3 https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://cell-split-exec.preview.emergentagent.com" "https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com"; do
