...
4. Origin Validation: Test with the specific frontend origin (https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com",  # Alternative origin
