...
echo "📍 Frontend: https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://968602d5-54dd-4504-a794-958add7beb1a.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
