...
if curl -s --max-time 3 https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com"; do
