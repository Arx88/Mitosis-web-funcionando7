...
FRONTEND_ORIGINS = [
    ...
    "https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com",
                f"https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com"
    ...
    return "https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://a03e2a3b-2372-487d-a3d3-fe850a25bc8e.preview.emergentagent.com":
