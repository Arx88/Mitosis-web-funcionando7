...
FRONTEND_ORIGINS = [
    ...
    "https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com",
                f"https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com"
    ...
    return "https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://58cc7fbd-8707-4128-b948-25dde4abd771.preview.emergentagent.com":
