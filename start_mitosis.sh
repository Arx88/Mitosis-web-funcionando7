...
VITE_BACKEND_URL=https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://50fa1ce8-422a-437f-b521-f208408f443e.preview.emergentagent.com"
    echo "=============================================================="
