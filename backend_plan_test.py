...
BACKEND_URL = "https://18ee1512-876b-47e6-b867-bac2b873f929.preview.emergentagent.com"
...
class MitosisPlanGenerationFlowTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://18ee1512-876b-47e6-b867-bac2b873f929.preview.emergentagent.com'
        })
        self.test_results = []
        self.task_id = None
    ...
    def test_cors_and_headers(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                cors_configured = (
                    cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://18ee1512-876b-47e6-b867-bac2b873f929.preview.emergentagent.com'] or
