...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
        "https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
