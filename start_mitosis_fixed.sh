...
echo "📍 Frontend: https://ad9dacf5-dede-4489-b6f8-f9fff164b3e3.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://ad9dacf5-dede-4489-b6f8-f9fff164b3e3.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
