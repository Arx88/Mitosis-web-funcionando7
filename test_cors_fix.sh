...
if curl -s --max-time 3 https://7ae20f51-337b-448c-97f9-960006d89615.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://7ae20f51-337b-448c-97f9-960006d89615.preview.emergentagent.com"; do
