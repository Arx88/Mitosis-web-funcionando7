...
4. Origin Validation: Test with the specific frontend origin (https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://34c40358-75f9-446c-9942-ad9f92d4bed7.preview.emergentagent.com",  # Alternative origin
