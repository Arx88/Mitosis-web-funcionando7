...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
    ...
    return "https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://98d9c6a7-2e56-4c60-a6d6-41303df55194.preview.emergentagent.com":
