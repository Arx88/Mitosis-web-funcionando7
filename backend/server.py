...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
    ...
    return "https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://01d1fb0a-2191-4491-bcee-9ff51b1eaedd.preview.emergentagent.com":
