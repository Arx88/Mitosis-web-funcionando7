...
4. Origin Validation: Test with the specific frontend origin (https://b8ebceaf-50cc-4408-8608-5935fd69100a.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://b8ebceaf-50cc-4408-8608-5935fd69100a.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://b8ebceaf-50cc-4408-8608-5935fd69100a.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://b8ebceaf-50cc-4408-8608-5935fd69100a.preview.emergentagent.com",  # Alternative origin
