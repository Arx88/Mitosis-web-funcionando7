...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
        "https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
