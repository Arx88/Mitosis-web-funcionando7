...
FRONTEND_ORIGINS = [
    ...
    "https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com",
                f"https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com"
    ...
    return "https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://fc78d5bf-5fbf-408c-a2e9-ae36aa212f40.preview.emergentagent.com":
