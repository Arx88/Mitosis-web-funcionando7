...
VITE_BACKEND_URL=https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://8fa1dc01-c3ce-476f-9641-88b06a3b331e.preview.emergentagent.com"
    echo "=============================================================="
