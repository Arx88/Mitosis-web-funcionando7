...
if curl -s --max-time 3 https://9a966b6d-c1d6-49fe-95bb-883d9ff13309.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://9a966b6d-c1d6-49fe-95bb-883d9ff13309.preview.emergentagent.com"; do
