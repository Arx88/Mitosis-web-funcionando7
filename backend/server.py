...
FRONTEND_ORIGINS = [
    ...
    "https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com",
                f"https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com"
    ...
    return "https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://cf3b468c-2f1b-49f1-91df-1c9e804df1c7.preview.emergentagent.com":
