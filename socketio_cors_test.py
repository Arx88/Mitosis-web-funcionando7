...
4. Origin Validation: Test with the specific frontend origin (https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com
...
BACKEND_URL = "https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com"
FRONTEND_ORIGIN = "https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com",  # Alternative origin
