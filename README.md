...
**Frontend (.env)**
```bash
VITE_BACKEND_URL=https://45dfeaa6-7eaf-4101-bc6c-20901a318336.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://45dfeaa6-7eaf-4101-bc6c-20901a318336.preview.emergentagent.com
```
