...
FRONTEND_ORIGINS = [
    ...
    "https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com",
                f"https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com"
    ...
    return "https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://4d806857-c9b3-4a66-b56b-60c439f73046.preview.emergentagent.com":
