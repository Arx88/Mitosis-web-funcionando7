...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com",
                f"https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
    ...
    return "https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://bbad0cf5-836b-4d9c-b4b9-a02749bc41fc.preview.emergentagent.com":
