...
if curl -s --max-time 3 https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"; do
