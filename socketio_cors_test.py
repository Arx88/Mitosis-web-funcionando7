...
4. Origin Validation: Test with the specific frontend origin (https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com",  # Alternative origin
