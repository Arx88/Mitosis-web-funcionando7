...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com",
                f"https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
    ...
    return "https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://ad01276f-2e57-4cb2-85ba-0b92009c892c.preview.emergentagent.com":
