...
VITE_BACKEND_URL=https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://a2a8582c-0473-4067-a2e3-f3964c12edee.preview.emergentagent.com"
    echo "=============================================================="
