...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com"
    ...
    return "https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com":
