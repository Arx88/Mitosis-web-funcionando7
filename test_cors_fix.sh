...
if curl -s --max-time 3 https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com"; do
