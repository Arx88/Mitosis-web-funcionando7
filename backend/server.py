...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://caa291c0-7fa9-4089-b57e-8fe9b9204de7.preview.emergentagent.com",
                f"https://caa291c0-7fa9-4089-b57e-8fe9b9204de7.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://caa291c0-7fa9-4089-b57e-8fe9b9204de7.preview.emergentagent.com"
    ...
    return "https://caa291c0-7fa9-4089-b57e-8fe9b9204de7.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://caa291c0-7fa9-4089-b57e-8fe9b9204de7.preview.emergentagent.com":
