...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://dbd293d5-e6d2-4c7c-a4bd-0a2c9f3b9e1c.preview.emergentagent.com"
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://dbd293d5-e6d2-4c7c-a4bd-0a2c9f3b9e1c.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://dbd293d5-e6d2-4c7c-a4bd-0a2c9f3b9e1c.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
