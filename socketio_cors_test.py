...
4. Origin Validation: Test with the specific frontend origin (https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com",  # Alternative origin
