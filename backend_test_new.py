...
BACKEND_URL = "https://c831651b-a7e8-429e-abcb-944983407842.preview.emergentagent.com"
...
class MitosisBackendHealthTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://c831651b-a7e8-429e-abcb-944983407842.preview.emergentagent.com'
        })
        self.test_results = []
        self.task_id = None
