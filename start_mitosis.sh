...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com ]]; then
    ...
    local test_patterns=(
        "https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com"
        "https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com"
        "https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
