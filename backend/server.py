...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://38146bbb-fcab-42f6-9cbd-f49422f98546.preview.emergentagent.com"
    ...
    return "https://38146bbb-fcab-42f6-9cbd-f49422f98546.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://38146bbb-fcab-42f6-9cbd-f49422f98546.preview.emergentagent.com":
