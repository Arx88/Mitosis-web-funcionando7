...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com",
                f"https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
    ...
    return "https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://b9e4a7d6-6664-404f-9a00-f2c8ca5f31cd.preview.emergentagent.com":
