...
FRONTEND_ORIGINS = [
    ...
    "https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com",
                f"https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com"
    ...
    return "https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://f89637ed-44f1-4cf4-a2d8-500a1734778c.preview.emergentagent.com":
