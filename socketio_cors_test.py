...
4. Origin Validation: Test with the specific frontend origin (https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com
...
BACKEND_URL = "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
FRONTEND_ORIGIN = "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com",  # Alternative origin
