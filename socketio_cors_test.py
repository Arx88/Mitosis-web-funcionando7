...
4. Origin Validation: Test with the specific frontend origin (https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com) to ensure it's allowed
...
Backend URL: https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com
...
FRONTEND_ORIGIN = "https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://54c94a9f-bbec-477e-8d3d-4922e13f3d86.preview.emergentagent.com",  # Alternative origin
