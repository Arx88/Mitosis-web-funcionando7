...
4. Origin Validation: Test with the specific frontend origin (https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com) to ensure it's allowed
...
BACKEND_URL = "https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com"
FRONTEND_ORIGIN = "https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://mitosis-runner-3.preview.emergentagent.com",  # Alternative origin
