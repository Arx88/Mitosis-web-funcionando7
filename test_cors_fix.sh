...
if curl -s --max-time 3 https://1d8c1b17-cbd1-4708-8b97-da2b0a69661f.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://1d8c1b17-cbd1-4708-8b97-da2b0a69661f.preview.emergentagent.com"; do
