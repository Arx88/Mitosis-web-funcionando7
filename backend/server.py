...
FRONTEND_ORIGINS = [
    ...
    "https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com",
                f"https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com"
    ...
    return "https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://9bb6cef7-7be1-4cef-bd58-be3cd38ac17d.preview.emergentagent.com":
