...
VITE_BACKEND_URL=https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com"
    echo "=============================================================="
