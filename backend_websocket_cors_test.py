...
BACKEND URL: https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://d608f718-a718-45a4-819a-24164cb88beb.preview.emergentagent.com']
