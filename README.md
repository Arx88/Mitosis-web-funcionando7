...
**Frontend (.env)**
```bash
VITE_BACKEND_URL=https://7f2f9f80-1044-4c65-ba29-a1b4a497c200.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://7f2f9f80-1044-4c65-ba29-a1b4a497c200.preview.emergentagent.com
```
