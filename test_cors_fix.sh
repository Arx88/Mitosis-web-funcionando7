...
if curl -s --max-time 3 https://64a3482e-5c9e-4f08-9906-c7e8583b532a.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://64a3482e-5c9e-4f08-9906-c7e8583b532a.preview.emergentagent.com"; do
