...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
    ...
    return "https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://da6b6894-ede2-4d4a-95d6-2882357b5107.preview.emergentagent.com":
