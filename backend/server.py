...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
    ...
    return "https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://f2e86a98-a98d-42ea-bb87-88f29c8c5e02.preview.emergentagent.com":
