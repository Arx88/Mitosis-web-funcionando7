...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://158be43a-d067-4263-a237-b024aaad0e09.preview.emergentagent.com"
    ...
    return "https://158be43a-d067-4263-a237-b024aaad0e09.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://158be43a-d067-4263-a237-b024aaad0e09.preview.emergentagent.com":
