...
BACKEND URL: https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com
...
class MitosisWebSocketCORSTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com',
    ...
    def test_cors_configuration(self) -> bool:
        ...
        try:
            ...
            origin_allowed = cors_headers['Access-Control-Allow-Origin'] in ['*', 'https://3440443f-1b4d-40a8-931a-a6b8c0a242e0.preview.emergentagent.com']
