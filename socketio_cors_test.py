...
4. Origin Validation: Test with the specific frontend origin (https://4bb53208-212c-440f-9581-7b02cf7ebdd3.preview.emergentagent.com) to ensure it's allowed
...
FRONTEND_ORIGIN = "https://4bb53208-212c-440f-9581-7b02cf7ebdd3.preview.emergentagent.com"
...
class SocketIOCORSTester:
    ...
    def test_origin_validation(self) -> bool:
        ...
        try:
            ...
            test_origins = [
                FRONTEND_ORIGIN,
                "https://4bb53208-212c-440f-9581-7b02cf7ebdd3.preview.emergentagent.com",  # Alternative origin
