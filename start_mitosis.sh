...
VITE_BACKEND_URL=https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://0b80d189-2d16-41d3-96e6-14926f319934.preview.emergentagent.com"
    echo "=============================================================="
