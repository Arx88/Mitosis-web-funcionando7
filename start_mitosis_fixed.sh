...
echo "📍 Frontend: https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://1bcbc563-0eb7-47cc-aed1-d326a3e6a573.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
