...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com"
    ...
    return "https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://f600a693-ea20-43b9-acb6-e8ada4e31f8a.preview.emergentagent.com":
