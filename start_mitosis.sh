...
check_external_access() {
    ...
    curl -s -f "https://e5264aee-8866-49fb-a2eb-7a4c7b869c9e.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://e5264aee-8866-49fb-a2eb-7a4c7b869c9e.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://e5264aee-8866-49fb-a2eb-7a4c7b869c9e.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://e5264aee-8866-49fb-a2eb-7a4c7b869c9e.preview.emergentagent.com"
    echo "=============================================================="
