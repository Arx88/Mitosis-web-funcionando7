...
if curl -s --max-time 3 https://7ac24ada-9a56-4ac5-8359-affff70362b6.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://7ac24ada-9a56-4ac5-8359-affff70362b6.preview.emergentagent.com"; do
