...
if curl -s --max-time 3 https://158be43a-d067-4263-a237-b024aaad0e09.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://158be43a-d067-4263-a237-b024aaad0e09.preview.emergentagent.com"; do
