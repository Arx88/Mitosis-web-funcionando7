...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com"
    ...
    return "https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://812df669-341c-4e0c-88be-55ef79256b5b.preview.emergentagent.com":
