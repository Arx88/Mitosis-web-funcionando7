...
**Frontend (.env)**
```bash
VITE_BACKEND_URL=https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://3d6d9a18-97d5-4f55-820d-6bc83fae60e1.preview.emergentagent.com
```
