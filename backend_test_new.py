...
BACKEND_URL = "https://5aa90c84-36b1-4873-81ab-1edc81506a21.preview.emergentagent.com"
...
class MitosisBackendHealthTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://5aa90c84-36b1-4873-81ab-1edc81506a21.preview.emergentagent.com'
        })
        self.test_results = []
        self.task_id = None
