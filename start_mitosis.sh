...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
        "https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://d0ae8b8a-2cb8-41b9-b9e7-9c5616783927.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
