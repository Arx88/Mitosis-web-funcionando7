...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://66c70af6-6d87-43bd-92ca-a2a4346963cb.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://66c70af6-6d87-43bd-92ca-a2a4346963cb.preview.emergentagent.com"
        "https://66c70af6-6d87-43bd-92ca-a2a4346963cb.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://66c70af6-6d87-43bd-92ca-a2a4346963cb.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://66c70af6-6d87-43bd-92ca-a2a4346963cb.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
