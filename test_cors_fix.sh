...
if curl -s --max-time 3 https://5b8e138b-cd29-424b-bbb2-18325b779df3.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://5b8e138b-cd29-424b-bbb2-18325b779df3.preview.emergentagent.com"; do
