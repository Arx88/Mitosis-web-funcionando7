...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com ]]; then
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://04f64c50-55e4-46ef-bb25-ab20f4298f29.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
