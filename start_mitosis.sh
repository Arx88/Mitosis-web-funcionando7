...
VITE_BACKEND_URL=https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://d0550d5a-3e14-4488-b413-deb644b90a8b.preview.emergentagent.com"
    echo "=============================================================="
