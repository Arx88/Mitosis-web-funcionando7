...
if curl -s --max-time 3 https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://24e59aef-d4f4-432c-a12f-0514fd334c3f.preview.emergentagent.com"; do
