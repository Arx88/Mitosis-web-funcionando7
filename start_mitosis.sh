...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
        "https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://a4fc4564-3c9e-463c-93d0-f9ae131b94bc.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
