...
if curl -s --max-time 3 https://c4f5be8b-db00-42e6-8dcc-7c4a057ac882.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://c4f5be8b-db00-42e6-8dcc-7c4a057ac882.preview.emergentagent.com"; do
