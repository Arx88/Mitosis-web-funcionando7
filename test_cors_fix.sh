...
if curl -s --max-time 3 https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com"; do
