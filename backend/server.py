...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://a2c0afe7-4e54-47fd-a0a6-bfa27bf20e4f.preview.emergentagent.com",
                f"https://a2c0afe7-4e54-47fd-a0a6-bfa27bf20e4f.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://a2c0afe7-4e54-47fd-a0a6-bfa27bf20e4f.preview.emergentagent.com"
    ...
    return "https://a2c0afe7-4e54-47fd-a0a6-bfa27bf20e4f.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://a2c0afe7-4e54-47fd-a0a6-bfa27bf20e4f.preview.emergentagent.com":
