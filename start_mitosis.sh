...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://594fc3fc-909f-42ec-a41d-f3921759852b.preview.emergentagent.com ]]; then
...
BASE_CORS_URLS=(
    ...
    "\"https://594fc3fc-909f-42ec-a41d-f3921759852b.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
