...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
        "https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://0b10b673-2b68-4662-b21c-3b0fd2c6261a.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
