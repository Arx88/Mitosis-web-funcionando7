...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com"
    ...
    return "https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://257fc3d4-e73d-4a5a-8b10-55c736ffbdfa.preview.emergentagent.com":
