...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com ]]; then
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://6fdadea9-df4d-44a4-adc8-feca2d77c031.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
