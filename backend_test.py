...
**URL Backend**: https://3a6a914f-38f4-4994-976b-6a526ad6d7a0.preview.emergentagent.com
...
class MitosisCORSAndConfigTester:
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'Origin': 'https://3a6a914f-38f4-4994-976b-6a526ad6d7a0.preview.emergentagent.com'  # Test CORS
        })
        self.test_results = []
        self.task_id = None
