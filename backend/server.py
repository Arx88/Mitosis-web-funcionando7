...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://62ce0bbb-d528-4241-84f3-572bb0f8170d.preview.emergentagent.com",
                f"https://62ce0bbb-d528-4241-84f3-572bb0f8170d.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://62ce0bbb-d528-4241-84f3-572bb0f8170d.preview.emergentagent.com"
    ...
    return "https://62ce0bbb-d528-4241-84f3-572bb0f8170d.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://62ce0bbb-d528-4241-84f3-572bb0f8170d.preview.emergentagent.com":
