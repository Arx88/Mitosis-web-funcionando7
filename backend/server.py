...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://7e7b2f0c-18f0-4054-9260-67c4cc41ee4a.preview.emergentagent.com",
                f"https://7e7b2f0c-18f0-4054-9260-67c4cc41ee4a.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://7e7b2f0c-18f0-4054-9260-67c4cc41ee4a.preview.emergentagent.com"
    ...
    return "https://7e7b2f0c-18f0-4054-9260-67c4cc41ee4a.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://7e7b2f0c-18f0-4054-9260-67c4cc41ee4a.preview.emergentagent.com":
