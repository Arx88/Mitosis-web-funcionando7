...
check_external_access() {
    ...
    curl -s -f "https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://774fd713-b4f7-45a0-a37e-a42a5d8a20be.preview.emergentagent.com"
    echo "=============================================================="
