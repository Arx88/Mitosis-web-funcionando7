...
FRONTEND_ORIGINS = [
    ...
    "https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com",
                f"https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com"
    ...
    return "https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://f35c69fb-0929-42ff-a06b-7355c1b320b0.preview.emergentagent.com":
