...
if curl -s --max-time 3 https://e16aaf8b-9515-4874-baf4-4996642c59cb.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://e16aaf8b-9515-4874-baf4-4996642c59cb.preview.emergentagent.com"; do
