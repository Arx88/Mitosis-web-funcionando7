...
if curl -s --max-time 3 https://e2860351-3f36-4a5a-8e08-706eca54fe3b.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://e2860351-3f36-4a5a-8e08-706eca54fe3b.preview.emergentagent.com"; do
