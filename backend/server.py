...
FRONTEND_ORIGINS = [
    ...
    "https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com",
                f"https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com"
    ...
    return "https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://af34534e-3e3e-459a-9f15-ee0a06ad29b2.preview.emergentagent.com":
