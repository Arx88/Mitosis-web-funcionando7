...
if curl -s --max-time 3 https://4bb53208-212c-440f-9581-7b02cf7ebdd3.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://4bb53208-212c-440f-9581-7b02cf7ebdd3.preview.emergentagent.com"; do
