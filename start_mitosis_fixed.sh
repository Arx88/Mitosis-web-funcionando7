...
echo "📍 Frontend: https://6a42dbad-573b-4631-929d-0d271703ed7e.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 Abrir: https://6a42dbad-573b-4631-929d-0d271703ed7e.preview.emergentagent.com"
    echo "=============================================================="
else
    echo ""
