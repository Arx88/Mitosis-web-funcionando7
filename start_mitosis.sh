...
detect_current_url() {
    ...
    if [ -f "/app/frontend/.env" ]; then
        ...
        if [[ "$existing_url" == https://98418f44-5444-41f9-9b1a-1a4c681609b0.preview.emergentagent.com ]]; then
...
BASE_CORS_URLS=(
    ...
    "\"https://98418f44-5444-41f9-9b1a-1a4c681609b0.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
