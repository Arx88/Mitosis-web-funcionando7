...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://c4f5be8b-db00-42e6-8dcc-7c4a057ac882.preview.emergentagent.com"
    ...
    return "https://c4f5be8b-db00-42e6-8dcc-7c4a057ac882.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://c4f5be8b-db00-42e6-8dcc-7c4a057ac882.preview.emergentagent.com":
