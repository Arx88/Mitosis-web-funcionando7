...
**Frontend (.env)**
```bash
VITE_BACKEND_URL=https://5a0d53f9-c995-4f4e-8a3d-7cb5dbe651e9.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://5a0d53f9-c995-4f4e-8a3d-7cb5dbe651e9.preview.emergentagent.com
```
