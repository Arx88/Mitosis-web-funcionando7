...
FRONTEND_ORIGINS = [
    ...
    "https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com",
...
def get_dynamic_cors_origins():
    ...
    try:
        ...
        if hostname.startswith('agent-env-'):
            ...
            preview_patterns = [
                f"https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com",
                f"https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com"
            ]
...
def get_current_environment_url():
    ...
    try:
        ...
        if '.emergentagent.' in hostname or '-' in hostname:
            ...
            if 'agent-env-' in hostname:
                ...
                return f"https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com"
    ...
    return "https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com"
...
def get_dynamic_cors_origins():
    ...
    if CURRENT_ENV_URL and CURRENT_ENV_URL != "https://df7e04d1-7a00-4462-aa06-dc6f9680c9e9.preview.emergentagent.com":
