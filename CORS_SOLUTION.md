...
**Error Original:**
```
Access to XMLHttpRequest at 'https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com/api/socket.io/' 
from origin 'https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com' has been blocked by CORS policy: 
...
```bash
EMERGENT_PREVIEW_URL=https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com
PREVIEW_URL=https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com
```
...
curl -s --max-time 2 https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com
```
...
FRONTEND_ORIGINS = [
    ...
    "https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com",
...
curl -H "Origin: https://0e9acadc-c511-44ef-9913-029260092624.preview.emergentagent.com" \
