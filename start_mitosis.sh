...
check_external_access() {
    ...
    curl -s -f "https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "🌐 URL: https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com"
    echo ""
    ...
    echo "   curl https://d1c8ceae-497e-462b-a5fa-5c5f477c24df.preview.emergentagent.com"
    echo "=============================================================="
