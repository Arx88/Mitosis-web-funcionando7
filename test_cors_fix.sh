...
if curl -s --max-time 3 https://d1426851-cff7-417a-8bf8-9f92c2fe94ff.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://d1426851-cff7-417a-8bf8-9f92c2fe94ff.preview.emergentagent.com"; do
