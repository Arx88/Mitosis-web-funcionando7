...
if curl -s --max-time 3 https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://2f624c51-ec2b-44ff-afc0-b55fee86c86e.preview.emergentagent.com"; do
