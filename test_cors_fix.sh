...
if curl -s --max-time 3 https://dbfc239b-4e7b-47b8-8e45-749b3bc48d99.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://dbfc239b-4e7b-47b8-8e45-749b3bc48d99.preview.emergentagent.com"; do
