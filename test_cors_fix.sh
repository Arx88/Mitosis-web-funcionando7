...
if curl -s --max-time 3 https://6f1dea1b-f2b9-4b55-b52c-7e8bcee0693d.preview.emergentagent.com >/dev/null 2>&1; then
...
for origin_url in "https://6f1dea1b-f2b9-4b55-b52c-7e8bcee0693d.preview.emergentagent.com"; do
