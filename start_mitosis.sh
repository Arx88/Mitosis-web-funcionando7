...
detect_current_url() {
    ...
    if [[ "$hostname_full" == agent-env-* ]]; then
        ...
        if [[ ${#container_id} -ge 8 ]]; then
            ...
            detected_url="https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
    ...
    local common_patterns=(
        "https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
        "https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
    )
...
case $DETECTION_METHOD in
    ...
    "FALLBACK")
        ...
        if [[ ${#CONTAINER_ID} -ge 8 ]]; then
            REAL_FRONTEND_URL="https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com"
...
BASE_CORS_URLS=(
    ...
    "\"https://d36ee792-175b-4269-b5a0-278867dacb1e.preview.emergentagent.com\""  # Wildcard para todos los previews
    "\"http://localhost:3000\""
    "\"http://localhost:5173\""
    "\"http://127.0.0.1:3000\""
    "\"http://127.0.0.1:5173\""
