...
VITE_BACKEND_URL=https://08a92d28-862e-4cf2-b6e0-0c3812d8904e.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://08a92d28-862e-4cf2-b6e0-0c3812d8904e.preview.emergentagent.com
EOF
...
check_external_access() {
    ...
    curl -s -f "https://08a92d28-862e-4cf2-b6e0-0c3812d8904e.preview.emergentagent.com" >/dev/null 2>&1
}
...
echo "=============================================================="
echo "📍 URL Externa: https://08a92d28-862e-4cf2-b6e0-0c3812d8904e.preview.emergentagent.com"
...
if $backend_ok && $frontend_ok; then
    ...
    echo "   curl https://08a92d28-862e-4cf2-b6e0-0c3812d8904e.preview.emergentagent.com"
    echo "=============================================================="
